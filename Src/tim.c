...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
    ...
    else if (htim == (&htim1))
    {
        ...
        ec11_data.diff >>= 1;
        ec11_data.diff = ec11_data.diff > 0 ? (ec11_data.diff * ec11_data.diff) : -(ec11_data.diff * ec11_data.diff);
...
void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim)
{
    if (htim == (&htim3))
    {
        __HAL_TIM_IS_TIM_COUNTING_DOWN(&htim3) ? ec11_data.diff++ : ec11_data.diff--;
